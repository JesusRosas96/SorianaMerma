            ...
            <page>
              <div class="body">
               ...
               <div>
                  <div id="details" class="clearfix">
                    <div id="client"> 
                      <div class="to">DATOS DE LA DESTRUCCIÓN:</div>
                      <?php echo 
              ...
              <div class="footer">
                  Soriana mantiene las actas de destrucción como garantía de que el producto será repuesto por el proveedor indicado.
              </div>
            </page>