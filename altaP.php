            ...
            <section class="probootstrap-section probootstrap-bg-white">
                ...
                <div class="container-fluid buscador">
                    <div class="row">
                        ...
                        <form action="/Merma/altaProd.php" enctype="multipart/form-data" method="post" name="AltaMerma">
                        <div id="formalities" class="row">
                            <div class="col">
                                ...
                                <p style="text-align: center;">
                                    Producto Ingresado:
                                    <input type="text" name="stock" class="form-control" placeholder="Ingrese la cantidad..."/>
                                </p>
                                <p style="text-align: center;">
                                    Precio:
                                    <input type="text" name="precio" class="form-control" placeholder="Ingrese la cantidad..."/>
                                </p>
                                <p style="text-align: center;">
