            ...
            <section class="probootstrap-section probootstrap-bg-white">
                ...
                <div class="container-fluid buscador">
                    <div class="row">
                        ...
                        <form action="/Merma/altaMerma.php" enctype="multipart/form-data" method="post" name="AltaMerma">
                        <div id="formalities" class="row">
                            <div class="col">
                                ...
                                <p style="text-align: center;">
                                    Área Departamental:
                                    <input type="text" name="area" class="form-control" placeholder="Ingrese el área..."/>
                                </p>
                                <p style="text-align: center;">
                                    Proveedor:
                                    <input type="text" name="proveedor" class="form-control" placeholder="Ingrese el proveedor..."/>
                                </p>
                                <p style="text-align: center;">
                                    Producto Entregado:
                                    <input type="text" name="prodent" class="form-control" placeholder="Ingrese la cantidad..."/>
                                </p>
                                <p style="text-align: center;">
                                    Producto Regresado:
                                    <input type="text" name="prodreg" class="form-control" placeholder="Ingrese la cantidad..."/>
                                </p>
                            </div>
                            <div class="col">
                                <p style="text-align: center;">
                                ...
                                <p style="text-align: center;">
                                    Forma de envio:
                                     <select name="forma" style="color: #000000">
                                ...
                                <p style="text-align: center;">
                                    Selecciona un imagen: <input type="file" name="foto" id="foto" size="30">
                                </p>
                                <p style="text-align: center;">
